...
@PageTitle("Azionechiave")
@Route("azionechiave")
@Menu(order = 6, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class AzionechiaveView extends Composite<VerticalLayout> {

    public AzionechiaveView() {
        ...
        textArea.setLabel("AZIONI CHIAVE *quelle azioni da valutare e discutere durante il debriefing");
        ...
        buttonPrimary.addClickListener(e -> {
            buttonPrimary.getUI().ifPresent(ui -> ui.navigate("pattoaula"));
        });
        buttonPrimary2.addClickListener(e -> {
            buttonPrimary2.getUI().ifPresent(ui -> ui.navigate("obiettivididattici"));
        });
    }
}
