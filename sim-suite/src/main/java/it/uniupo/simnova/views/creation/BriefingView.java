...
public class BriefingView extends Composite<VerticalLayout> {
    ...
    public BriefingView() {
        ...
        TextArea briefingArea = new TextArea("BRIEFING");
        ...
        backButton.addClickListener(e ->
                backButton.getUI().ifPresent(ui -> ui.navigate("descrizione")));

        nextButton.addClickListener(e -> {
            nextButton.getUI().ifPresent(ui -> ui.navigate("pattoaula"));
        });
    }
}