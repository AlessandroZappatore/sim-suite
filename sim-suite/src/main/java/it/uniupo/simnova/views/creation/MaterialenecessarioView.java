...
public class MaterialenecessarioView extends Composite<VerticalLayout> {
    ...
    public MaterialenecessarioView() {
        ...
        textArea.setLabel("MATERIALE NECESSARIO *allestimento e attrezzatura dentro la sala");
        ...
        buttonPrimary.addClickListener(event -> {
            buttonPrimary.getUI().ifPresent(ui -> ui.navigate("obiettivididattici"));
        });

        buttonPrimary2.addClickListener(event -> {
            buttonPrimary2.getUI().ifPresent(ui -> ui.navigate("esamiReferti"));
        });
    }
}
