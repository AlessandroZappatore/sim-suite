...
public class MoulageView extends Composite<VerticalLayout> {
    ...
    public MoulageView() {
        ...
        TextArea moulageArea = new TextArea("MOULAGE");
        ...
        backButton.addClickListener(e ->
                backButton.getUI().ifPresent(ui -> ui.navigate("esamiReferti")));

        nextButton.addClickListener(e -> {
            nextButton.getUI().ifPresent(ui -> ui.navigate("liquidi"));
        });
    }
}