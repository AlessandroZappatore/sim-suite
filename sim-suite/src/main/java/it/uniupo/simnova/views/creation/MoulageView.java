...
public class MoulageView extends Composite<VerticalLayout> {
    ...
    public MoulageView() {
        ...
        textArea.setLabel("MOULAGE *trucco da effettuare al manichino/paziente simulato");
        ...
        buttonPrimary.addClickListener(event -> {
            buttonPrimary.getUI().ifPresent(ui -> ui.navigate("esamiReferti"));
        });

        buttonPrimary2.addClickListener(event -> {
            buttonPrimary2.getUI().ifPresent(ui -> ui.navigate("liquidi"));
        });
    }
}
