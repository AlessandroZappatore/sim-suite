...
public class PattoaulaView extends Composite<VerticalLayout> {

    public PattoaulaView() {
        ...
        textArea.setLabel("PATTO D'AULA / FAMILIARIZZAZIONE *da leggere e mostrare all'interno della sala");
        ...
        buttonPrimary.addClickListener(e -> {
            buttonPrimary.getUI().ifPresent(ui -> ui.navigate("briefing"));
        });

        buttonPrimary2.addClickListener(e -> {
            buttonPrimary2.getUI().ifPresent(ui -> ui.navigate("azionechiave"));
        });
    }
}
