...
public class DescrizioneView extends Composite<VerticalLayout> {
    ...
    public DescrizioneView() {
        ...
        textArea.setLabel("DESCRIZIONE SCENARIO *descrizione dettagliata dello scenario");
        ...
        buttonPrimary.addClickListener(e -> {
            buttonPrimary.getUI().ifPresent(ui -> ui.navigate("startCreation"));
        });

        buttonPrimary2.addClickListener(e -> {
            buttonPrimary2.getUI().ifPresent(ui -> ui.navigate("briefing"));
        });
    }
}
